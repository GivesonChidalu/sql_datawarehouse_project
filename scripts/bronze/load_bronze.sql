...
===============================================================================
PURPOSE:
    Nukes the existing data and performs a fresh reload of the Bronze Layer.
    
STRATEGY: 
    TRUNCATE-AND-LOAD. We wipe the tables clean first to kill duplicates, 
    reset identity counters, and ensure the Bronze layer is a perfect 1:1 
    snapshot of the raw source files. Fast, clean, and zero 'ghost' data.

EXECUTION:
    - Truncates CRM and ERP landing tables.
    - Executes BULK INSERTs from local CSV datasets.
    - Logs performance metrics and catches errors if the pipeline breaks.
===============================================================================
*/
